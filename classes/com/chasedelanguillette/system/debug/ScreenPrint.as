package com.chasedelanguillette.system.debug
{
	...
	public class ScreenPrint extends Object
	{
		...
		public static var _alignment:int = ALIGN_LOWER_RIGHT;
		public static function set alignment(value:int):void
		{
			_alignment = value;
			updateAlignment();
		}
		...
		{
			_alignment++;
			if (_alignment == ALIGN_MODE_TOTAL) _alignment = 0;
			updateAlignment();
		}
		
		public static function updateAlignment():void
		{
			//trace("ScreenPrint::nextAlignment() -> " + _alignment);
			...
			//trace("_alignment: " + _alignment + " printContainer.x :: " + printContainer.x + ", printContainer.y :: " + printContainer.y);
		}
